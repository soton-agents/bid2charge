...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Completion.approved'
        db.add_column(u'webapp_completion', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Completion.worker_id'
        db.add_column(u'webapp_completion', 'worker_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Completion.assignment_id'
        db.add_column(u'webapp_completion', 'assignment_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Completion.approved'
        db.delete_column(u'webapp_completion', 'approved')

        # Deleting field 'Completion.worker_id'
        db.delete_column(u'webapp_completion', 'worker_id')

        # Deleting field 'Completion.assignment_id'
        db.delete_column(u'webapp_completion', 'assignment_id')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
