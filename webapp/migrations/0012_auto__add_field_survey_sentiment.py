...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.sentiment'
        db.add_column(u'webapp_survey', 'sentiment',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.sentiment'
        db.delete_column(u'webapp_survey', 'sentiment')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)'}),
