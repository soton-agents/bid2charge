...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EVUser.is_turker'
        db.add_column(u'webapp_evuser', 'is_turker',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EVUser.is_turker'
        db.delete_column(u'webapp_evuser', 'is_turker')


    models = {
        u'webapp.accountevent': {
            'Meta': {'object_name': 'AccountEvent'},
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
        ...
        u'webapp.auctionhistory': {
            ...
            'recorded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
        ...
        u'webapp.evuser': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
