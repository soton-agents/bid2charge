...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Treatment.active'
        db.add_column(u'webapp_treatment', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Treatment.active'
        db.delete_column(u'webapp_treatment', 'active')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 27, 0, 0)'}),
