...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuctionEvent.marginal_prices'
        db.alter_column(u'webapp_auctionevent', 'marginal_prices', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'AuctionEvent.user_marginal_values'
        db.alter_column(u'webapp_auctionevent', 'user_marginal_values', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'AuctionEvent.marginal_prices'
        db.alter_column(u'webapp_auctionevent', 'marginal_prices', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'AuctionEvent.user_marginal_values'
        db.alter_column(u'webapp_auctionevent', 'user_marginal_values', self.gf('django.db.models.fields.CharField')(max_length=500))

    models = {
        u'webapp.accountevent': {
            'Meta': {'object_name': 'AccountEvent'},
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 0, 0)'}),
        ...
        u'webapp.auctionhistory': {
            ...
            'recorded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 0, 0)'}),
        ...
        u'webapp.evuser': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 0, 0)'}),
