...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EVUser.completed_tutorial'
        db.add_column(u'webapp_evuser', 'completed_tutorial',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EVUser.completed_tutorial'
        db.delete_column(u'webapp_evuser', 'completed_tutorial')
