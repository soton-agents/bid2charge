...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.usability_answers'
        db.add_column(u'webapp_survey', 'usability_answers',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Survey.usability_score'
        db.add_column(u'webapp_survey', 'usability_score',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.usability_answers'
        db.delete_column(u'webapp_survey', 'usability_answers')

        # Deleting field 'Survey.usability_score'
        db.delete_column(u'webapp_survey', 'usability_score')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 11, 0, 0)'}),
