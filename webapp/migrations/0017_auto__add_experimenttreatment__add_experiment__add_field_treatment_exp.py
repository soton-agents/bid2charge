...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Treatment.experiment'
        db.add_column(u'webapp_treatment', 'experiment',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Treatment.experiment'
        db.delete_column(u'webapp_treatment', 'experiment_id')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 19, 0, 0)'}),
