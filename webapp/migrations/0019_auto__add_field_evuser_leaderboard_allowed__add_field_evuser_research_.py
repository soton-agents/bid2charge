...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EVUser.leaderboard_allowed'
        db.add_column(u'webapp_evuser', 'leaderboard_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EVUser.research_allowed'
        db.add_column(u'webapp_evuser', 'research_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EVUser.leaderboard_allowed'
        db.delete_column(u'webapp_evuser', 'leaderboard_allowed')

        # Deleting field 'EVUser.research_allowed'
        db.delete_column(u'webapp_evuser', 'research_allowed')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 21, 0, 0)'}),
