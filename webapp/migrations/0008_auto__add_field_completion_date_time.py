...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Completion.date_time'
        db.add_column(u'webapp_completion', 'date_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 11, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Completion.date_time'
        db.delete_column(u'webapp_completion', 'date_time')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
