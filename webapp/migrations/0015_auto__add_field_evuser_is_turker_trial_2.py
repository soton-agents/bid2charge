...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EVUser.is_turker_trial_2'
        db.add_column(u'webapp_evuser', 'is_turker_trial_2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EVUser.is_turker_trial_2'
        db.delete_column(u'webapp_evuser', 'is_turker_trial_2')
    ...
    models = {
        ...
        u'webapp.completion': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 2, 0, 0)'}),
