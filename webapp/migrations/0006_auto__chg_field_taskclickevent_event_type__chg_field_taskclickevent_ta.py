...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskClickEvent.event_type'
        db.alter_column(u'webapp_taskclickevent', 'event_type', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'TaskClickEvent.task_selection_after'
        db.alter_column(u'webapp_taskclickevent', 'task_selection_after', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'TaskClickEvent.task_description'
        db.alter_column(u'webapp_taskclickevent', 'task_description', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'TaskClickEvent.task_selection_before'
        db.alter_column(u'webapp_taskclickevent', 'task_selection_before', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'TaskClickEvent.event_type'
        db.alter_column(u'webapp_taskclickevent', 'event_type', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'TaskClickEvent.task_selection_after'
        db.alter_column(u'webapp_taskclickevent', 'task_selection_after', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'TaskClickEvent.task_description'
        db.alter_column(u'webapp_taskclickevent', 'task_description', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'TaskClickEvent.task_selection_before'
        db.alter_column(u'webapp_taskclickevent', 'task_selection_before', self.gf('django.db.models.fields.CharField')(max_length=200))
